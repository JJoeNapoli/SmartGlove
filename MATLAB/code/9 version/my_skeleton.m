...
for i=1:size(W,1)
    if Itrust(i,1) == true
        plot3(W(i,1), W(i,2), W(i,3),'Marker', '.', 'Color', 'green','MarkerSize', 22);
    elseif Itrust(i,1) == false
        plot3(W(i,1), W(i,2), W(i,3),'Marker', '.', 'Color', 'red','MarkerSize', 22);
    end
